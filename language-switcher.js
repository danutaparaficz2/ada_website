(function () {
    ...
    function applyAdaBetterTranslations(lang) {
        ...
        var cardTranslations = [
            ...
            { badge: { en: 'Interpretable Machine Learning', de: 'Interpretierbares maschinelles Lernen' }, desc: { en: 'Develop physics-inspired and intepretable neural network architectures. ', de: 'Entwicklung physik-inspirierter und interpretierbarer neuronaler Netzwerkarchitekturen.' }, meta: { en: 'Partner: Data Science Lab (University of Bern)', de: 'Partner: Data Science Lab (Universität Bern)' } },
            { badge: { en: 'Process Engineering AI', de: 'KI für Verfahrenstechnik' }, desc: { en: 'Develop LLM powered application to interact with process and instrumentation diagrams.', de: 'Entwicklung einer LLM-gestützten Anwendung zur Interaktion mit Fließbildern und Instrumentierungsdiagrammen.' }, meta: { en: 'Partner: FHNW / AITEXA', de: 'Partner: FHNW / AITEXA' } },
    ...
    function applyProjectsTranslations(lang) {
        ...
        var homeCardTranslations = [
            ...
            { badge: { en: 'Interpretable Machine Learning', de: 'Interpretierbares maschinelles Lernen' }, title: { en: 'Project MuRS', de: 'Projekt MuRS' }, desc: { en: 'Develop physics-inspired and intepretable neural network architectures. ', de: 'Entwicklung physik-inspirierter und interpretierbarer Neuronaler Netzwerke.' } },
            { badge: { en: 'Process Engineering AI', de: 'KI für Verfahrenstechnik' }, title: { en: 'Project AITEXA', de: 'Projekt AITEXA' }, desc: { en: 'Develop LLM powered application to interact with process and instrumentation diagrams.', de: 'Entwicklung einer LLM-gestützten Anwendung zur Interaktion mit Fließbildern und Instrumentierungsdiagrammen.' } },
            ...
            { badge: { en: 'Industry 4.0', de: 'Industrie 4.0' }, title: { en: 'SkillsFinder', de: 'SkillsFinder' }, desc: { en: 'Automatic skills extraction and profile validation platform.', de: 'Plattform zur automatischen Extraktion und Validierung von Kompetenzen.' } }
        ];
        ...
        var sectionTitles = {
            ...
            murs: { en: 'Project MuRS', de: 'Projekt MuRS' },
            aitexa: { en: 'Project AITEXA', de: 'Projekt AITEXA' },
    ...
    function applyProjectDetailLongForm(lang) {
        ...
        setSectionProse('murs', {
            en: '<p class="text-lg text-slate-700 font-medium italic mb-2">This project explores a more interpretable alternative to transformer attention mechanisms, the core component of the neural network architecture used in many modern AI models. Inspired by particle interactions, the proposed Multi-Representation Scattering (MuRS) framework models relationships between data elements in a simpler and more transparent way. The goal is to better understand what models learn and when they may fail, while still achieving strong performance on standard machine learning tasks. This work is especially relevant for applications where trust, accountability, and explainability are important. We are seeking industrial and academic partners interested in collaborating on a follow-up Swiss National Science Foundation (SNF) project. If you are interested in potential collaboration opportunities on this topic, please contact the project leaders.</p>'
                + '<div class="border-l-4 border-blue-600 pl-6 my-6 py-2 bg-blue-50 rounded-r">'
                + '<h4 class="font-bold mb-2 text-xs uppercase tracking-widest text-blue-700">Partners</h4>'
